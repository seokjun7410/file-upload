...
| [`docs/adr/0008-limit-multipart-upload-size.md`](docs/adr/0008-limit-multipart-upload-size.md) | multipart 업로드 파일 1개를 100MB, 전체 요청을 110MB로 제한하는 정책 | accepted |
| [`docs/adr/0008-limit-extension-name-characters.md`](docs/adr/0008-limit-extension-name-characters.md) | 커스텀 확장자 이름을 한글·영문·숫자로 제한하는 입력 정책 | accepted |
