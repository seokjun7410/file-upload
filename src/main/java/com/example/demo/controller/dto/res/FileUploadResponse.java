package com.example.demo.controller.dto.res;

import com.example.demo.service.UploadedFile;

/** 파일 업로드 성공 결과를 REST 응답으로 표현한다. */
public record FileUploadResponse(String filename, String message) {
    ...
    public static FileUploadResponse from(UploadedFile uploadedFile) {
        return new FileUploadResponse(uploadedFile.filename(), SUCCESS_MESSAGE);
    }
}
