...
- 응답: `200 OK`
- `fixed`: 고정 확장자 7개의 `extension`, `blocked` 목록
...
- [ ] 커스텀 확장자 추가를 Axios `POST /api/v1/extension-policies/custom`으로 호출한다.
- [ ] 추가 성공 결과를 목록과 사용자 메시지에 반영한다.
- [ ] `400`, `409` 및 공통 오류 JSON의 `message`를 사용자 메시지로 표시한다.
